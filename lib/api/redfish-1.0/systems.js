...
var postSystems = controller(function(req, res) {
    console.log("GPVP We are inside the controller");
    console.log("GPVP : %j", res);
    var options = redfish.makeOptions(req, res, "FAKE");
    console.log("BHLD HERE")
    var data = req.swagger.params.payload.value;
    console.log("BHLD data: " +  JSON.stringify(data, null, 4));
    /* 
    return Promise.props({
    ...
    console.log("GPVP: we are inside data function")
    ...
    .then(function(result){
        fs.writeFile("/tmp/catalogs.json", JSON.stringify(result, null, 4), function() {});
        return result; 
       
             //.createFile('/tmp/poc.json')
             //.then(function(path) {
